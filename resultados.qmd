...
```
  ...
  Ao considerar a influência de variáveis relacionadas ao paciente, tratamento e hospital na duração da internação,o modelo de regressão linear múltipla fornece insights valiosos.  O modelo linear múltiplo é representado pela seguinte equação: 
#### COLOCAR EQUAÇÃO
